...
// const maxResultsPicker = () => {
//     return (
//         <select defaultValue={maxResults}>
    ...
    if (!pokemonList.results || pokemonList.results.length === 0) {
        ...
        return (
            <div className="flex flex-col gap-2 overflow-hidden h-full ">
                ...
                <div className='h-16 shrink-0 flex flex-col items-center justify-center w-full '>
                    <span className='text-gray-500'>
                        Showing { maxResults } results per page
                    </span>
                    <Pagination
